...
contract ERCXXXXReceiverDelegate is ProxyReceiverStorage_002_ERCXXXXFuture {
    bytes4 public constant ERCXXXX_RECEIVED = 0x1234AAAA;
    bytes4 public constant ERCXXXX_BATCH_RECEIVED = 0x4321BBBB;
    bytes4 public constant NOT_ERCXXXX_RECEIVED = 0xDEADF00D; // Some random value
    ...
    function onERCXXXXReceived(
        ...
        (_id);
        (_value);
        (_data); // solidity, be quiet please
